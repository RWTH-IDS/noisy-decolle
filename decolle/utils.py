...
def prepare_experiment():
    ...
    parser.add_argument('--quantise_training', type=int, help='Enter number of bits to quantise during training') 
    ...
    parser.add_argument('--quantise_test', type=int, help='Enter number of bits to quantise during test') 
